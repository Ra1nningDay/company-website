...
export default function HeroSection() {
    return (
        <section className="w-full py-24 px-6 text-center  text-black pb-60  relative">
            ...
            <div className="flex justify-center items-center gap-4">
                <Button className="text-white text-[18px] bg-black  py-7 px-6 hover:cursor-pointer">
