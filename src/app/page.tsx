    ...
    return (
        <div className="min-h-screen bg-[#fffffe] font-sans">
            ...
            <section className="py-20 px-6 bg-white text-center">
                <h2 className="text-3xl font-semibold mb-6">About OCTOTECH</h2>
                <p className="max-w-3xl mx-auto text-lg">
                    We&apos;re a passionate team of developers and consultants
                    helping businesses embrace the future through smart,
                    ethical, and effective AI-driven technology.
                </p>
            </section>
